...
int main(int argc, char **argv) {
  ...
  if (testReverse) {
    ...
    assert(strcmp(phnumGet(pnum, 3), "957") == 0);
    assert(strcmp(phnumGet(pnum, 4), "98") == 0);
    assert(strcmp(phnumGet(pnum, 2), "9*7") == 0);
    ...
    assert(strcmp(phnumGet(pnum, 0+2), "0") == 0);
    assert(strcmp(phnumGet(pnum, 1+2), "1") == 0);
    assert(strcmp(phnumGet(pnum, 2+2), "2") == 0);
    assert(strcmp(phnumGet(pnum, 3+2), "3") == 0);
    assert(strcmp(phnumGet(pnum, 4+2), "4") == 0);
    assert(strcmp(phnumGet(pnum, 5+2), "5") == 0);
    assert(strcmp(phnumGet(pnum, 6+2), "51") == 0);
    assert(strcmp(phnumGet(pnum, 7+2), "6") == 0);
    assert(strcmp(phnumGet(pnum, 8+2), "7") == 0);
    assert(strcmp(phnumGet(pnum, 9+2), "8") == 0);
    assert(strcmp(phnumGet(pnum, 10+2), "9") == 0);
    ...
    pnum = phfwdReverse(pf, "51");
    assert(strcmp(phnumGet(pnum, 0+1), "1") == 0);
    assert(strcmp(phnumGet(pnum, 1+1), "2") == 0);
    assert(strcmp(phnumGet(pnum, 2+1), "3") == 0);
    assert(strcmp(phnumGet(pnum, 3+1), "4") == 0);
    assert(strcmp(phnumGet(pnum, 4+1), "51") == 0);
    assert(strcmp(phnumGet(pnum, 5+1), "6") == 0);
    assert(strcmp(phnumGet(pnum, 6+1), "7") == 0);
    assert(strcmp(phnumGet(pnum, 7+1), "8") == 0);
    assert(strcmp(phnumGet(pnum, 8+1), "9") == 0);
    assert(strcmp(phnumGet(pnum, 0), "*") == 0);
