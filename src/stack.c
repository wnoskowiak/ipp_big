...
stack_t *add(stack_t *stack, PhoneForward *item) {
      ...
      // dodawanie elementu na koniec kolejki i ustawianie wskaźnika na ostatni
      // element w kolejce stack->front += 1;
...
PhoneForward *pop(stack_t *stack) {
      ...
      // odczytywanie danych z początku kolejki i przesuwanie wskaźnika na
      // początek kolejki do tyłu
